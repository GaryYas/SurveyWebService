...
public class SurveyEntity {
    ...
    public boolean equals(Object o) {
        ...
        return id == that.id && sleepRate == that.sleepRate && skinCondition == that.skinCondition && Objects.equals(user, that.user) && Objects.equals(createdAt, that.createdAt);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, sleepRate, skinCondition, user, createdAt);
    }
